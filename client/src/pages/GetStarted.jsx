...
const GetStarted = () => {
  return (
    <div className='get-started'>
      ...
      <p className='title'>Connecting ChainFund with MetaMask</p>
      <div className='section'>
        <p className='number'>1</p>
        <div className='content'>
      ...
      <div className='section'>
        <p className='number'>2</p>
        <div className='content'>
          <p className='title'>Go back to the ChainFunding website</p>
          <p className='text'></p>
        </div>
      </div>
      <div className='section'>
